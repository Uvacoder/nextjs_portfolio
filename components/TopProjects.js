...
export default function TopProjects() {
  return (
    <section className="from-blue-200 bg-gradient-to-t -mt-40 dark:from-gray-900">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-20 lg:my-0">
          <h2 className="text-6xl lg:text-9xl max-w-lg font-bold text-gray-500 my-20 md:my-0 md:text-white dark:text-gray-600 lg:text-left">
            Top Projects
          </h2>
          <Link href="/work">
